...
//                       <Phone className="mr-2 w-5 h-5 sm:w-6 sm:h-6 text-[#04348c] transition-all duration-300" />
//                       LLAMAR AHORA
//                     </div>
...
//                       <svg
//                         className="mr-2 w-5 h-5 sm:w-6 sm:h-6 text-white  transition-all duration-300"
//                         fill="currentColor"
//                         viewBox="0 0 24 24"
//                       >
