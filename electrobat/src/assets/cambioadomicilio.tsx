        ...
        <div className="container mx-auto px-4 max-w-6xl">
              ...
              >
                <div className="text-center flex-1 flex flex-col">
                  <div className="bg-white rounded-2xl p-6 shadow-xl border-2 border-[#e7d21e] relative z-10 transform hover:scale-105 transition-all duration-300 flex-1 flex flex-col">
                    ...
                    <h3 className="text-2xl font-bold text-[#04348c] mb-3">
                      Control gratuito cada seis meses
                    </h3>
          ...
          >
            <button
              ...
              onClick={handlePhoneClick}
              className="cursor-pointer inline-flex items-center px-8 py-3 bg-gradient-to-r from-[#04348c] to-blue-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-blue-800 hover:scale-105 transition-all duration-300 shadow-xl text-lg"
            >
