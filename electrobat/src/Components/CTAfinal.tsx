    ...
    <section className="py-10 bg-gray-50 ">
      <div className="container mx-auto px-4 max-w-xl text-center">
        ...
        <h2 className="text-xl md:text-xl font-bold text-[#04348c] mb-2">
          ¿Listo para olvidarte de los problemas de batería?
        </h2>
        
        {/* Subtítulo */}
        <p className="text-sm text-gray-700 mb-3">
          Cambiamos tu batería en minutos y te damos un control gratuito al año.
        </p>
        
        {/* Beneficios */}
        <div className="flex justify-center items-center gap-4 mb-4 text-xs text-gray-600">
          <span>En Rosario centro</span>
          <span>•</span>
          <span>Sin turno</span>
          <span>•</span>
